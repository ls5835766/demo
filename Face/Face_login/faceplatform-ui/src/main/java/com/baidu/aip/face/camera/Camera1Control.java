...
//        parameters.setRotation(90); // TODO
        ...
        rotation = setCameraDisplayOrientation(context, rotation, cameraId, camera);
        final Camera.Size size = camera.getParameters().getPreviewSize();

        int detectRotation = rotation;
    ...
    public static int setCameraDisplayOrientation(Context context, int degrees,
