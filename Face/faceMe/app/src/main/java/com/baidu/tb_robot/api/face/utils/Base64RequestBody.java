    ...
    public void writeTo(BufferedSink sink) throws IOException {
        ...
        if (fileMap != null && fileMap.size() > 0) {
            ...
            for (String k : fileMap.keySet()) {
                ...
                LogUtil.i("FaceMember", "write to " + fileMap.get(k));

                file = fileMap.get(k);
                LogUtil.i("FaceMember", "file:" + file.length());
                ...
                LogUtil.i("FaceMember", "Base64RequestBody buf:" + Arrays.toString(buf));
        ...
        LogUtil.i("FaceMember", "result:" + result);
        sink.close();
    }
